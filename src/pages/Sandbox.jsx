          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className={`font-bold text-gray-900 dark:text-white transition-all duration-300 ${isScrolled ? 'text-lg' : 'text-2xl'}`}>
                    Automation Sandbox
                  </h1>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto p-8 pt-6 pb-32">
          <div className="bg-blue-600 dark:bg-blue-700 rounded-2xl p-8 mb-12 text-white shadow-xl relative overflow-hidden group">
            <div className="relative z-10">
              <h2 className="text-3xl font-black mb-4 uppercase tracking-tighter">Advanced Widget Testing</h2>
              <p className="max-w-2xl text-blue-100 font-medium leading-relaxed">
                Welcome to the specialized sandbox. This area is designed for testing complex UI interactions 
                like dynamic list filtering, date range selection, and nested DOM extractions.
              </p>
            </div>
            {/* Visual Decor */}
            <div className="absolute top-0 right-0 p-4 opacity-10 transform translate-x-4 -translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-700">
               <svg className="w-64 h-64" fill="currentColor" viewBox="0 0 24 24"><path d="M11 2v20c-5.07 0-9.22-3.9-9.73-8.83L1.04 12l.23-1.17C1.78 5.9 5.93 2 11 2zm2 0c5.07 0 9.22 3.9 9.73 8.83l.23 1.17-.23 1.17C22.22 18.1 18.07 22 13 22V2z"/></svg>
            </div>
          </div>
