      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 transition-colors duration-300">
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className={`transition-all duration-300 ${isScrolled ? 'scale-90' : 'scale-100'}`}>
                  ...
                  <div className={`flex items-center transition-all duration-300 ${isScrolled ? 'opacity-0 h-0 w-0 overflow-hidden' : 'opacity-100 mt-1 h-5'}`}>
                    <span className="w-2 h-2 rounded-full bg-green-500 mr-2 flex-shrink-0"></span>
                    <span className="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">Authenticated Session Active</span>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto p-8 pt-6 pb-32">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 mb-8 border border-gray-200 dark:border-slate-700 text-gray-800 dark:text-slate-200 relative group">
            ...
            <p className="text-sm break-all font-mono bg-gray-50 dark:bg-slate-700/50 p-4 rounded-lg border border-gray-200 dark:border-slate-600" data-testid="session-token-text">
              {token}
            </p>
          </div>
