...
const Sidebar = ({ isOpen, onClose }) => {
  const menuItems = [
    ...
    { name: 'Product Gallery', path: '/sandbox#products', icon: '🛍️', category: 'Advanced Scenarios' },
    { name: 'Date & Form Pickers', path: '/sandbox#forms', icon: '📅', category: 'Advanced Scenarios' },
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold">QA</div>
          ...
          <div className="p-6 border-t border-gray-100 dark:border-slate-800">
            <div className="bg-gray-50 dark:bg-slate-800/50 rounded-2xl p-4">
              <p className="text-[10px] text-gray-400 dark:text-slate-500 font-mono mb-1">AUTOMATION STATUS</p>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                <span className="text-xs font-bold text-gray-700 dark:text-slate-300">Hub Ready for Stress</span>
              </div>
            </div>
          </div>
        </div>
