...
const FileUpload = () => {
  ...
  return (
    <div
      id="file-upload"
      className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden col-span-1 h-auto md:h-96 flex flex-col"
    >
